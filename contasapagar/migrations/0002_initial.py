# Migration 0002_initial: adiciona empresa_id só se a coluna não existir (evita "duplicate column" em produção)
# Use este arquivo no servidor para substituir a 0002_initial que quebrava com duplicate column.
