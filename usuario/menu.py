...
ITENS_MENU: tuple[MenuItemDef, ...] = (
    ...
    MenuItemDef('estoque', 'Estoque', 'fa-boxes', 'cadastro', url_name='estoque:produto_list'),
    MenuItemDef('inventario', 'Inventário', 'fa-clipboard-list', 'cadastro', url_name='inventario:inventario_list'),
